-- Ensure every authenticated user has a server-side demo account.
...
REVOKE ALL ON FUNCTION public.ensure_demo_account() FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.ensure_demo_account() TO authenticated;

-- Make PostgREST refresh its function schema after deployment.
